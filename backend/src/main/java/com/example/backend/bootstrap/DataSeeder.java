...
public class DataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                if (eventoRepository.count() == 0 && usuarioRepository.count() == 0
                        ...
                        e7.setDescripcion(
                                        "Exposición floral al aire libre, talleres de jardinería y venta de plantas exóticas.");
                        ...
                        e9.setDescripcion(
                                        "Prueba los últimos modelos de coches, patinetes y bicicletas eléctricas del mercado.");
